...
Publishing House provides a `gitops-helper` skill that generates Helm charts and ArgoCD manifests for your lab environment. You can also build them manually — the skill is optional.
