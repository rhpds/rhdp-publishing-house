#!/bin/bash
# Build and push the Readme Backend RHDH dynamic plugin as an OCI image
...
IMAGE="quay.io/rhpds/backstage-plugin-readme-backend:${VERSION}"
...
echo ""
echo "==> Done. Add to dynamic-plugins ConfigMap:"
echo ""
echo "  package: 'oci://quay.io/rhpds/backstage-plugin-readme-backend:${VERSION}!backstage-plugin-readme-backend'"
