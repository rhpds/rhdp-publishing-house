#!/bin/bash
# Build and push the Readme RHDH dynamic plugin as an OCI image
#
# Usage:
...
IMAGE="quay.io/rhpds/backstage-plugin-readme:${VERSION}"
...
echo ""
echo "  package: 'oci://quay.io/rhpds/backstage-plugin-readme:${VERSION}!backstage-plugin-readme'"
